$(document).ready(function() {
    var c = {setting: {startline: 20,scrollto: 0,scrollduration: 300,fadeduration: [500, 100]},controlHTML: '<img src="static/images/top_btn.gif" style="width:85px; height:85px" />',controlattrs: {offsetx: 0,offsety: 30},anchorkeyword: "#top",state: {isvisible: !1,shouldvisible: !1},scrollup: function() {
            ...
            jQuery(document).ready(function(a) {
                ...
                "</div>").css({position: b.cssfixedsupport ? "fixed" : "absolute",bottom: b.controlattrs.offsety,left: "50%",marginLeft: "500px",opacity: 0,cursor: "pointer"}).attr({title: "返回顶部"}).click(function() {
                    b.scrollup();
                    return !1
                }).appendTo("body");
